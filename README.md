...
To speed up testing, we recommend saving a copy of one of the skill files (e.g. /shopping/data/skills/skill4_multilingual.json to be /shopping/data/skills/skill4_multilingual_short.json) and trimming the file to only 100 lines, which will make it process much faster.
